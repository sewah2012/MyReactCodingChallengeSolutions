...
import DarkModeContext from '../../../common/containers/ContextAPI/DarkModeContext';
            ...
            return <div className="app">
              <div className="level">
                ...
                <button className="app__dark-mode-btn icon level-right" onClick={toggleDarkMode} >
                  <FontAwesomeIcon icon={darkMode ? faSun : faMoon} color={darkMode ? '#FFA500' : 'inherit'} />
                </button>
             ...
             <Link to='/mypage'> <a className="button is-primary">Navigate to my page</a></Link>
